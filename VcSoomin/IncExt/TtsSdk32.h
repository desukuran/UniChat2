...
#define		M_SYNCHRONOUS			0x0100
#define		M_ASYNCHRONOUS			0x0200
#define		M_MIXING_LANGUAGE		0x0400
...
int  FAR PASCAL TtsGetMrkRecords(HTTSINSTANCE hTtsInst, HANDLE *phMrkInfo, 
								 int *pnMrkNo, int *pnTextIdx);
...
void FAR PASCAL TtsInitGetSysInfo( LPTTSSYSTEMINFO lpSystemInfo ) ;
...
int  FAR PASCAL TtsSpeakPhonString(HTTSINSTANCE hTtsInst, int nDevId, int nPhonMode, int nPhonLen,
								   LPBYTE lpszUTFText); 
